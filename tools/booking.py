...
_HutBuddy Team_ 💚"""
        ...
        if is_web_booking:
            ...
            save_web_message_to_db(booking.user.user_id, confirmation_message, sender="bot")
        else:
            # For WhatsApp bookings, send via WhatsApp
            send_whatsapp_message_sync(user_phone, confirmation_message, booking.user.user_id, save_to_db=True)
